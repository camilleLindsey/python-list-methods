...
print('The index of WannaCry:', index)
...
print('The count of 98.105:', count)
...
print('Original List:', mr_robot)
mr_robot.reverse()
print('Updated List:', mr_robot)
